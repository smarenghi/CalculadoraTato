...
//Las condiciones que se me ocurren:todos numeros, mayores que 0.
//distanciaPantallaPiso >= 1.5
//ySala > distanciaPantallaPiso + anchoPantalla + 0.2
//largoPantalla < zSala
//xAsiento < xSala
//zAsiento < zSala
...
function isoptica(){
    ...
    //otra opcion para dar el tamaño de la pantalla podría ser aspect ratio y diagonal
    //var aspectRatio = 16/9; //que el menu despliegue las opcioes posibles
    //var diagonalPantalla = 4 //diagonal de la pantalla ¿en metros? ¿pulgadas?
    
    
    //PARAMETROS FIJOS
    //se puede darle al usuario la posibilidad de elegir "máxima calidad" o "máxima cantidad de butacas"
    var diferenciaAltura = 0.10; //Entre los ojos y el tope de la cabeza. ¿Optima 0.15?
    var alturaOjosEspectador = 1.50; //de los pies a los ojos, sentado
    var alfa = 61.8; //angulo en grados desde la mitad de la pantalla. Puede llegar hasta 80

    //VALORES QUE PUEDE DETERMINAR LA CALCULADORA
    var distanciaPrimerFila = 4.20;			//distancia de la primer fila a la pantalla. CALCULAR!!!
    //var distanciaÚltimaFila = // De acuerdo al tema del ángulo
    ...
    function getTanDeg(deg) {
      ...
      return Math.tan(rad);
        ...
        var tan = 0;
        while (distanciaFila <= (xSala - xAsiento) && yOjo <= ySala - diferenciaAltura) {
        ...
        alert(xEscalon[0]);
//        td2.appendChild(document.createTextNode(xEscalon[1]));
...
//        document.getElementById("yOjos").innerHTML = yOjos;
        ...
        document.getElementById("totalAsientos").innerHTML = cantidadFilas * asientosPorFila; //tener en cuenta que los ángulos te restan asientos!
        ...
        var canvasWidth = window.innerWidth *0.95; // Austar dibujos al ancho de la pantalla, con un pequeño margen.
